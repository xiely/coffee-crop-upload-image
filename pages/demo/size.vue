        ...
        handleCrop(e) {
            uni.uploadFile({
                ...
                header: {
                    ...
                    'Authorization': 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI0MCIsInBsYXRmb3JtIjoiY29mZmVlX2FkbWluXyIsImlhdCI6MTc1MDc2NTI2NiwiZXhwIjoxNzUwNzY4ODY2fQ.ZeskKgNFxnCk_pm0uqJsHR8JIOudN_Upc4ErXnWRPxE',
                },
                fileType: "image",
